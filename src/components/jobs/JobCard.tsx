    ...
    <Link href={`/ilan/${job.id}`} className="block group">
      ...
      >
        ...
        {hasImage ? (
          ...
          /* Fallback: No image placeholder with sector icon */
          <div className="relative aspect-[16/9] w-full bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
